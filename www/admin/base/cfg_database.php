   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <select name="sys_ver">
               ...
               <option value="6.0"<?php if($sys_ver==6.0)echo " selected";
?>>船说 ( 分表版 )</option>
               <option value="2.5"<?php if($sys_ver==2.5)echo " selected";
?>>船说 ( 优化版 )</option>
               <option value="1.7"<?php if($sys_ver==1.7)echo " selected";
?>>杰奇 1.x</option>
               <option value="2.4"<?php if($sys_ver==2.4)echo " selected";
?>>杰奇 2.x</option>
               <option value="3.0"<?php if($sys_ver==3.0)echo " selected";
?>>杰奇 3.x</option>
           </select>
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="text" name="dbhost" value="<?=$dbarr['host']?>" autocomplete="off" class="layui-input">
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="text" name="dbport" value="<?=$dbarr['port']?>" autocomplete="off" class="layui-input">
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="text" name="dbname" value="<?=$dbarr['name']?>" autocomplete="off" class="layui-input">
       </div>
   </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="text" name="dbuser" value="<?=$dbarr['user']?>" autocomplete="off" class="layui-input">
       </div>
   </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="password" name="dbpass" value="<?=$dbarr['pass']?>" autocomplete="off" class="layui-input">
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline switch-wd">
           <input type="checkbox" name="db_pconnect" lay-skin="switch" lay-filter="db_pconnect" lay-text="ON|OFF"<?php if(!empty($dbarr['pconnect']))echo ' checked' ?>>
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline" style="width:100%;max-width: 550px;">
           <input type="text" name="authcode" placeholder="解密版无需填写，无限制多多支持www.huaitui.com" value="<?=$authcode?>" autocomplete="off" class="layui-input">
       </div>
   </div>
</form>
